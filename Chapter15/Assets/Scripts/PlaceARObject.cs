...
public class PlaceARObject : MonoBehaviour
{
    ...
    /// <summary>
    /// A reference to the Raycast Manager for being able to perform
    ///	raycasts
    /// </summary>
    ARRaycastManager raycastManager;

    /// <summary>
    /// A reference to the AR camera to know where to draw raycasts from
    /// </summary> 
    Camera arCamera;
    ...
    /// <summary>
    /// Start is called before the first frame update. Initialize our
    /// private variables
    /// </summary>
    void Start()
    {
    ...
    private void LateUpdate()
    {
        ...
        /* Check if there is something in front of the center of the
         * screen and update the placement indicator if needed */ 
